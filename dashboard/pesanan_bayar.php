<!-- Nama File : pesanan_bayar.php -->
<!-- Deskripsi : Halaman untuk melihat dan merubah pesanan yang berstatus menunggu pembayaran -->
        ...
        <div class="offcanvas-body">
            ...
            <li class="nav-item mb-2"><a class="dropdown dropdown-toggle"data-bs-toggle="collapse" data-bs-target="#pesanan" aria-expanded="false" aria-controls="pesanan">
                ...
                <div class="sub-menu collapse group-dividers mb-2" id="pesanan">
                    ...
                    <li class="nav-item mb-2 ms-4"><a href="pesanan_bayar.php" class="active text-white">Menunggu Pembayaran</a></li>
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4">
                <div class="header mb-4 p-4">
                    <h3><i class="fa-solid fa-bag-shopping me-2"></i>Menunggu Pembayaran</h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card p-3">
                                ...
                                <table class="table table-striped table-bordered align-middle text-center"> 
                                    ...
                                    <?php
                                        ...
                                        $sqlSewa =  "SELECT 
                                                    ...
                                                    AND user.user_name=pesanan.user_name AND pesanan.status ='Menunggu Pembayaran'
            ...
            if(isset($_POST['update'])){
                ...
                echo "<script type='text/javascript'>
                        ...
                        document.location = 'pesanan_bayar.php'; 
                    </script>";
            } 
            ?>
