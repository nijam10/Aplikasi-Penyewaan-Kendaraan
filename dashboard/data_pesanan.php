<!-- Nama File : deta_pesanan.php -->
<!-- Deskripsi : Halaman admin untuk melihat semua data pesanan yang masuk -->
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4">
                <div class="header mb-4 p-4">
                    <h3><i class="fa-solid fa-bag-shopping me-2"></i>Data Pesanan</h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card p-3">
                                    ...
                                    <?php
                                        ...
                                        if (isset($_GET['keyword'])) {
                                            ...
                                            $sqlSewa =  "SELECT 
                                                    ...
                                                    AND user.user_name=pesanan.user_name
                                                    AND kode_pesanan LIKE '%$keyword%'
                                                    OR nama_kendaraan LIKE '%$keyword%'
                                                    OR pesanan.user_name LIKE '%$keyword%'
                                                    OR pesanan.status LIKE '%$keyword%'
                                        ...
                                        $countData = mysqli_num_rows($querySewa);
                                        if ($countData < 1) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Tombol lihat -->
                                                <button 
                                                    class="btn btn-primary btn-sm me-1 btn-lihat" 
        ...
        document.querySelectorAll('.btn-lihat').forEach(button => {
            button.addEventListener('click', function () {
                ...
                if (this.dataset.bukti) {
                    ...
                    modalBuktiGambar.alt = 'Belum ada bukti pembayaran';
                }
            });
        });
    </script>
