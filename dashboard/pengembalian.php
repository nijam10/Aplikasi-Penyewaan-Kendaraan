<!-- Nama File : pengembalian.php -->
<!-- Deskripsi : Halaman untuk melihat dan mngedit data kendaraan dan pesanan yang belum dikembalikan -->
        ...
        <div class="offcanvas-body">
            ...
            <li class="nav-item mb-2"><a class="dropdown dropdown-toggle"data-bs-toggle="collapse" data-bs-target="#pesanan" aria-expanded="false" aria-controls="pesanan">
                ...
                <div class="sub-menu collapse group-dividers mb-2" id="pesanan">
                    ...
                    <li class="nav-item mb-2 ms-4"><a href="pengembalian.php" class="active text-white">Pengembalian</a></li>
                </div>
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4">
                <div class="header mb-4 p-4">
                    <h3><i class="fa-solid fa-bag-shopping me-2"></i>Pengembalian Kendaraan</h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card p-3">
                                ...
                                <table class="table table-striped table-bordered align-middle text-center"> 
                                    ...
                                    <?php
                                        ...
                                        $sqlSewa =  "SELECT 
                                                    ...
                                                    AND user.user_name=pesanan.user_name AND pesanan.status ='Sudah Dibayar'
